    ...
    items-center py-3 px-4 sm:px-20 xl:px-32'>
        <img src={assets.logo} alt="logo" className='w-32 sm:w-44 cursor-pointer' onClick={()=>
            navigate('/')}/>
            {
              ...
              :
              (
       <button onClick={openSignIn} className='flex items-center gap-3 rounded-full text-sm
       cursor-pointer bg-primary text-white px-10 py-2.5 font-semibold'>Get Started<ArrowRight
